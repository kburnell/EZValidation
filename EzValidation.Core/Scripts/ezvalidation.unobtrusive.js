...
ezvalidation.comparison = function (value1, operator, value2) {
...
(function () {
    jQuery.validator.addMethod("comparison", function (value, element, params) {
        var dependentProperty = ezvalidation.getID(element, params["dependentproperty"]);
        ...
        if (ezvalidation.comparison(value, operator, dependentValue))
            return true;
    ...
    $Unob.adapters.add("comparison", ["dependentproperty", "operator"], function (options) {
        setValidationValues(options, "comparison", {
